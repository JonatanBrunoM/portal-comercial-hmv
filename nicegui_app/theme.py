...
STYLE_ORDER = (
    ...
    "styles/nicegui/admin_portals.css",
    "styles/nicegui/admin_credentials.css",
    "styles/nicegui/admin_documents.css",
    "styles/nicegui/admin_contacts.css",
    "styles/nicegui/admin_consultants.css",
